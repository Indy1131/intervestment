...
function setYear(newYear, datasets) {
  ...
  const all_increases = Object.keys(countries).map((country) => {
    if (
      ...
      // const prevTotal = countries[country].years[year - 1].outputs.unemployment;
      const currentTotal = countries[country].years[year].outputs.unemployment;
